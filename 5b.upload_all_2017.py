...
#Attention ---   Year : 2017, start date, end date, Time 8 hours 5 minutes, Change directory OS.chdir
...
for i in invertors:
    ...
    start = datetime.datetime.strptime("1-01-2017", "%d-%m-%Y")
    end = datetime.datetime.strptime("1-1-2018", "%d-%m-%Y")   # One day after the end date
