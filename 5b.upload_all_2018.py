...
#Attention ---   Year : 2018, start date, end date, Time 8 hours 15 minutes, Change directory OS.chdir
...
for i in invertors:
    ...
    end = datetime.datetime.strptime("1-1-2019", "%d-%m-%Y")   # One day after the end date
