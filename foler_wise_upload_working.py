# This program creates the df for the specified no of dates : Time 8 hours 22 minutes
...
"SN0005000043200066","SN0005000043200083","SN0005000043200089"]
##### Program starts #####
for i in invertors:
    invertorID=i
    ...
    end = datetime.datetime.strptime("2-1-2018", "%d-%m-%Y")   # One day after the end date
